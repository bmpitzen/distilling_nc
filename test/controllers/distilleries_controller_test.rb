...
class DistilleriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create distillery" do
    assert_difference('Distillery.count') do
      post distilleries_url, params: { distillery: { city: @distillery.city, name: @distillery.name, region_id: @distillery.region_id, stree_address: @distillery.stree_address, tour_cost: @distillery.tour_cost, tours: @distillery.tours, website: @distillery.website, zip: @distillery.zip } }
    end
  ...
  test "should update distillery" do
    patch distillery_url(@distillery), params: { distillery: { city: @distillery.city, name: @distillery.name, region_id: @distillery.region_id, stree_address: @distillery.stree_address, tour_cost: @distillery.tour_cost, tours: @distillery.tours, website: @distillery.website, zip: @distillery.zip } }
